...
public class CameraIntegrationTests {
    ...
    public void PlaneIntegration() {
        ...
        cameraIntegrations(new Plane(new Vector(0, 0, 1), new Point(0, 0, 5)), camera, 9, "TC01");

        // TC02: 9 intersection points- plane with small angle
        cameraIntegrations(new Plane(new Vector(0, -1, 2), new Point(0, 0, 5)), camera, 9, "TC02");

        // TC03: 6 intersection points- plane parallel to lower rays
        cameraIntegrations(new Plane(new Vector(0, -1, 1), new Point(0, 0, 5)), camera, 6, "TC03");
