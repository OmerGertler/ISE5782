...
public class LightsTests {
	...
	public void sphereDirectional() {
		...
		camera1.setImageWriter(imageWriter) //
				...
				.renderImage();
		camera1.setImageWriter(imageWriter).writeToImage();
	}
	...
	public void trianglesMultiLight() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights
				.add(new SpotLight(trCL, new Point(20, 50, -50), new Vector(0, -2, -1)).setKl(0.002).setKq(0.0001));
		scene2.lights.add(new PointLight(trCL, new Point(0, 0, -145)).setKl(0.002).setKq(0.0001));
		scene2.lights.add(new DirectionalLight(new Color(100, 0, 0), new Vector(1, 1, -1)));
	...
	/**
	 * Produces an image of a sphere illuminated by a number of lights
	 */
	@Test
	public void sphereMultiLight() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(spCL, new Point(60, 20, 10), new Vector(0, -2, -1)).setKl(0.002).setKq(0.0001));
		scene1.lights.add(new PointLight(spCL, new Point(-100, 100, -50)).setKl(0.001).setKq(0.0001));
		scene1.lights.add(new DirectionalLight(spCL, new Vector(1, 1, -0.5)));
